...
\sol{1}{10}{$S = \sum_{i=1}^2N_i k_B \ln \left( \frac{N_i k_B T}{P_i} \right) + \frac{3}{2} (N_1+N_2) k_B \left[ \ln \left( \frac{4 \pi m}{3 h^2} \right) + \ln \left( \frac{3}{2} k_B T \right)+1 \right]$}{1} \\
