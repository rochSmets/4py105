...
\question
Calculer $\D _{\alpha} I_n(\alpha)$ et l'exprimer en fonction de I_{n+2}(\alpha)$.
...
\tiret{La fonction  Gamma et la factorielle}
...
\tiret{Les factorielles des grands nombres et la formule de Stirling}
