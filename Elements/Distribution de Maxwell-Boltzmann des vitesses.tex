\elements{
\\
1 : $ \int_{-\infty}^{+\infty} {\rm d}v_x \int_{-\infty}^{+\infty} {\rm d}v_y \int_{-\infty}^{+\infty} {\rm d}v_z P(\vec v)= C \Big[\int_{-\infty}^{+\infty} {\rm d}v_x {\rm e}^{-\beta \frac{mv_x^2}{2}} \Big]^3=C \Big[ \sqrt{\frac{2\pi}{\beta m}} \Big]^3= 1$ (car $P$ est normalisée) donc $C=\big[\frac{\beta m}{2\pi} \big]^{\frac{3}{2}}$.
\\
2 : Par symétrie :
